...
public enum LogMessages {
    ...
    STOPPING_SERVER("Signal [{0}] is received, stopping the server soon..."),
    ...
    INVALID_ID("Invalid id: {0}"),
    INVALID_LEVEL_ID("Invalid level id: {0}"),
    INVALID_URI("Invalid URI: {0}"),
    INVALID_SESSION_KEY("Invalid Session Key: {0}"),
